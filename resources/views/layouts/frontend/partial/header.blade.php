            ...
            <div class="col-sm-12">
                <div>
                    <a href="{{ route('welcome') }}"> <img src="{{ asset('frontend/img/logoo.png') }}"
                                                           style="height: 80px; width: 140px" alt="logo"
            ...
            <ul class="navbar-nav mr-auto">
                ...
                @else
                    @if (Auth::user()->role_id == 2)
                        <li class="nav-item"><a class="nav-link" href="{{ route('landlord.dashboard') }}">Dashboard</a>
                        </li>
                    ...
                    @if (Auth::user()->role_id == 3)
                        <li class="nav-item"><a class="nav-link" href="{{ route('renter.dashboard') }}">Dashboard</a>
                        </li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('logout') }}"
                                                    onclick="event.preventDefault();
                             document.getElementById('logout-form').submit();">
